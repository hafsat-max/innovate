...
const StarSection = () => {
  return (
    <section className=' h-[608px] bg-[url("/star.png")] bg-no-repeat bg-cover bg-center pb-6 px-60p flex  items-end justify-between '>
      <div className='flex flex-col gap-[60px] w-full app-container'>
        <h3 className='text-white font-bold text-4xl max-w-[400px] druk'>WE HELP ARTISTS FIND THEIR FANS</h3>
